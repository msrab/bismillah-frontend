...
function App() {
  return (
    <Box sx={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f8fafc 0%, #f1f1f1 100%)' }}>
      ...
      <Box component="footer" sx={{ py: 4, textAlign: 'center', color: '#888', fontSize: '1rem', background: '#fff', borderTop: '1px solid #eee' }}>
        &copy; 2025 Bismillah. Tous droits réservés.
      </Box>
    </Box>
  );
}
